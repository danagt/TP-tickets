...
function totalAPagar(){
    ...
    let totalTickets= (cantidad.value) * valorTicket; // 1 * 200, 2 * 200...
    ...
    if (categoria.value == "estudiante") {
        totalTickets = Math.abs((totalTickets * estudiante) - totalTickets); //200 * 0.80 - 200
    }
    if (categoria.value == "trainee") {
        totalTickets = Math.abs((totalTickets * trainee) - totalTickets); //200 * 0.50 - 200 
    }
    if (categoria.value == "junior") {
        totalTickets = Math.abs((totalTickets * junior) - totalTickets); //200 * 0.15 - 200
    }
